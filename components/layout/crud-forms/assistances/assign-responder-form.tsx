...
import { assignResponderSchema } from "@/schemas/index"
...
export const AssignResponderForm = ({ id, setIsOpen }: { id: string, setIsOpen: Dispatch<SetStateAction<boolean>> }) => {
  ...
  const form = useForm<z.infer<typeof assignResponderSchema>>({
    resolver: zodResolver(assignResponderSchema),
    defaultValues: {
      id: id
    }
  })

  const onSubmit = (payload: z.infer<typeof assignResponderSchema>) => {
    setError("");
    setSuccess("");
    startTransition(() => {
