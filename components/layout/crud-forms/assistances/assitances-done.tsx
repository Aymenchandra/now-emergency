...
export const AssistanceDoneForm = ({ id, setIsOpen }: { id: string, setIsOpen: Dispatch<SetStateAction<boolean>> }) => {
  ...
  const form = useForm<z.infer<typeof updateEmergencyStatusSchema>>({
    resolver: zodResolver(updateEmergencyStatusSchema),
    defaultValues: {
      id: id
    }
  })

  const onSubmit = (payload: z.infer<typeof updateEmergencyStatusSchema>) => {
    setError("");
    setSuccess("");
    startTransition(() => {
